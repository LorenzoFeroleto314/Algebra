...
\begin{observ}[Una relazione piu' generica di sottoanello]{obs sottoanello}
...
\footnotetext{{Ad esempio, si verifica facilmente che la mappa 
...
cioè tali anelli non sono confrontabili secondo l'inclusione.}}
